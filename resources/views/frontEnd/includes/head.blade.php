...
<link href="{{ URL::asset('public/frontEnd/css/fancybox/jquery.fancybox.css') }}" rel="stylesheet">
<link href="{{ URL::asset('public/frontEnd/css/jcarousel.css') }}" rel="stylesheet"/>
...
<link href="{{ URL::asset('public/frontEnd/css/color.css') }}" rel="stylesheet"/>

@if( trans('backLang.direction')=="rtl")
<link href="{{ URL::asset('public/frontEnd/css/rtl.css') }}" rel="stylesheet"/>
@endif
