            ...
            <div class="box-body">
                ...
                @if(Helper::GeneralWebmasterSettings("gr_box_status"))
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            {!! Form::text('title_gr',$Banners->title_gr, array('placeholder' => '','class' => 'form-control','id'=>'title_gr','required'=>'', 'dir'=>trans('backLang.ltl'))) !!}
                        </div>
                    </div>
                @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    @if($Banners->file_gr!="")
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="col-sm-4 box p-a-xs">
                                                        <a target="_blank"
                                                           href="{{ URL::to('uploads/banners/'.$Banners->file_gr) }}"><img
                                                                    src="{{ URL::to('uploads/banners/'.$Banners->file_gr) }}"
                                        ...
                                        @else
                                            <a target="_blank"
                                               href="{{ URL::to('uploads/banners/'.$Banners->file_gr) }}">{!!  $Banners->file_gr !!}</a>
                                        @endif
                                    @endif
                ...
                @if($WebmasterBanner->desc_status)
                    ...
                    @if(Helper::GeneralWebmasterSettings("gr_box_status"))
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                {!! Form::textarea('details_gr',$Banners->details_gr, array('placeholder' => '','class' => 'form-control', 'dir'=>trans('backLang.ltl'),'rows'=>'3')) !!}
                            </div>
                        </div>
