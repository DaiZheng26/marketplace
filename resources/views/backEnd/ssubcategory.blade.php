    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="box-header dker">
                <h3>{{ Subcategory::find($category_id)->name }}</h3>
                <small>
            ...
            @if($Categories->total() >0)
                @if(@Auth::user()->permissionsGroup->webmaster_status)
                    <div class="row p-a pull-right" style="margin-top: -70px;">
                        <div class="col-sm-12">
                            <a class="btn btn-fw primary" href="{{route("ssubcategoriesCreate",["category_id"=>$category_id])}}">
                    ...
                    <table class="table table-striped  b-t">
                        ...
                        @foreach($Categories as $Category)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route("ssubCategories",["category_id"=>$Category->id]) }}"
                                ...
                                <div class="modal-dialog" id="animate">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ route("ssubcategoriesDestroy",["id"=>$Category->id,"$category_id"]) }}"
